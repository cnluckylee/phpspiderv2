...
class elements {
    ...
    const CATEGORYPAGECHARSET = 'category_page_charset'; //网站编码
    ...
    const ITEM_COMMENTS = 'item_comments';
    ...
    const FETCHTIMEOUT = 'fetch_time_out';//抓取超时

    const HTML_ZIP = 'html_zip';//网页压缩格式

    const NOITEMJOB = 'no_item_job';//不需要item job
    /**
     * 批量更新数据
     */
