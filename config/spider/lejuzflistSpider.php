...
$siteconfig = array(
        ...
        elements::ITEMCOMMON=>array(
            ...
            'AgentUrl'=>'//a[@class="block clearfix"]/@href||1',
            'AgentName'=>'//em[@class="block c_666"]/text()||1',
            'Company'=>'//span[@class="f12"]/text()||1',
        ),
		elements::STID => 123,
        elements::HTML_ZIP =>'gzip',
		elements::DATASOURCE => '1',
		elements::COLLECTION_ITEM_NAME => 'lejuzf_Items',
		elements::COLLECTION_CATEGORY_NAME => 'lejuzf_list_category',
        elements::ITEMPAGECHARSET => 'utf-8',
        elements::FETCHTIMEOUT=>30,
