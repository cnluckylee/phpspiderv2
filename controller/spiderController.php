...
class spiderController extends Controller {
    ...
    /**
         ...
         * categoryretry
         */
        public function retrycategoryerr()
        {
            $this->model->retry('CategoryErr');
        }

        public function retrycategorylisterr()
        {
            $this->model->retryerr('CategoryList');
        }

        public function categoryerrjob()
        {
            $this->model->CategroyErrJob();
        }
        /**
         * categoryretry
         */
